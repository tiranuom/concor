...
export default class ContinuationTask extends React.Component {
    ...
    render() {
        ...
        return <g transform={`translate(${x}, ${y}) scale(0.5)`} >
            ...
            <Queue x={155} y={70} color={'yellow'} queueSize={queueSize} type={'s'}/>
            <g transform="translate(120,30)">
                <foreignObject>
                    <div onClick={this.onClick.bind(this)} style={{width: 110, height: 110, opacity: 0.1}}></div>
                </foreignObject>
            </g>
        </g>
    }
